...
public class Menu extends JFrame {
    public Menu(){
        ...
        cur.setVisible(true);
        JButton JQueryAll=new JButton("查询所有系");
        JButton JQuery=new JButton("查询系信息");
        JButton JAdd=new JButton("增加系信息");
        JButton JChange=new JButton("修改系信息");
        JButton JDelete=new JButton("删除系信息");
