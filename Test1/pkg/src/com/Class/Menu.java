...
public class Menu extends JFrame {
    public Menu(){
        ...
        cur.setVisible(true);
        JButton JQueryAll=new JButton("查询所有班级");
        JButton JQuery=new JButton("查询班级信息");
        JButton JAdd=new JButton("增加班级信息");
        JButton JChange=new JButton("修改班级信息");
        JButton JDelete=new JButton("删除班级信息");
